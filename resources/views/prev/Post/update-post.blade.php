            ...
            <div class="col-md-6">
                <form action="{{ url('/post/update/'.$post->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10"> 
                            <input class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ $post->title }}" type="text" />
                        </div>
                    @error('title')
                    <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="col-10"> 
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" cols="50">{{ $post->description }}</textarea>
                        </div>
                    @error('description')
                    <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
